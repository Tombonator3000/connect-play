...
// ============================================================================
// RE-EXPORTS FROM MODULAR CONSTANTS
// ============================================================================
// These constants have been extracted to separate modules for better organization.
// Import directly from './constants/moduleName' for tree-shaking benefits.
...
export {
  ...
  isDesperateActive,
  getDesperateMeasure
} from './constants/desperateMeasures';
...
// NOTE: HQ_WEAPONS and HQ_ARMOR are now in ./constants/weapons.ts
...
// NOTE: BESTIARY is now in ./constants/bestiary.ts (re-exported at the top of this file)
...
// NOTE: DESPERATE_MEASURES, getActiveDesperateMeasures, and calculateDesperateBonuses
// are now in ./constants/desperateMeasures.ts (re-exported at the top of this file)

// NOTE: CRITICAL_BONUSES, CRITICAL_PENALTIES, getRandomCriticalBonuses, and getRandomCriticalPenalty
// are now in ./constants/criticals.ts (re-exported at the top of this file)
